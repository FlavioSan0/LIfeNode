...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn("fixed inset-0 z-50 bg-life-bg/80 backdrop-blur-sm", className)}
    {...props}
    ref={ref}
  />
));
...
const sheetVariants = cva("fixed z-50 gap-4 bg-card p-5 shadow-panel transition ease-in-out", {
  variants: {
    side: {
